        ...
        <footer className="bg-white py-4">
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm px-4">
                ...
                <p className="text-center flex items-center gap-1">
                    ...
                    por <Link href="//agenciaideaspro.cl" className="text-primary hover:underline">Agencia Ideas Pro</Link>.
                </p>
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="http://instagram.com/tuimagenlab" className="text-gray-400 hover:text-gray-500">
